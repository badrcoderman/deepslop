...
// ⚠ INERT LEGACY — NOT WIRED INTO DEEPSLOP.
// This file is the original slopkit2 AIO loader ("ufm42") and CANNOT run
// standalone here: it references globals that do not exist in deepslop
// (TITLE_ID, file_exists, PROT_RWX, MAP_SHARED, read_file, Thrd_create,
// Thrd_join, check_jailbroken, write_buffer, call) and it duplicates
// load_aioshellcode(), which lapse-runtime.js:1318 already defines
// self-contained. Keep for reference only.
//
// If it must run again: bind TITLE_ID, PROT_RWX/MAP_SHARED consts, route
// file_exists/read_file through lapse-runtime's ipv6_kernel_rw (or its stub),
// and use ipv6_kernel_rw.write_buffer(addr, buf, size).
